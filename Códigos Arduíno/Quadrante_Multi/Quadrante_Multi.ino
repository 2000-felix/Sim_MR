...
// Read Mixture
  Mixture = analogRead(A2); // Hall effect sensor connects to this analog pin

// Read Mixture
  Passo = analogRead(A1); // Hall effect sensor connects to this analog pin

// Read Brakes
  Compensador = analogRead(A3); // Hall effect sensor connects to this analog pin

// Read Throttle

  Throttle = (4*oldThrottle + analogRead(A0))/5; // Potentiometer signal connects to this analog pin
...
// Output Controls
  ...
  Joystick.setRyAxis(Passo);
  Joystick.setZAxis(Compensador);
